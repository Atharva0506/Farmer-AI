                            ...
                            <CardContent className="p-4 flex gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <Badge variant="secondary" className="text-xs font-bold bg-yellow-50 text-yellow-700 hover:bg-yellow-100 border-yellow-200">
                                            ★ {farmer.rating}
                                        </Badge>
                                    </div>
                        ...
                        {recentRequirements.map((req, i) => (
                            ...
                            >
                                ...
                                <Badge
                                    ...
                                    className={req.status === "Active" ? "bg-green-100 text-green-700 hover:bg-green-200 border-green-200" : ""}
                                >
                                    {req.status}
                                </Badge>
                            </div>
